...
class HaProxyUpstreamResolverTests(unittest.TestCase):
    ...
    def test_automatic_upstream_never_uses_mdns(self) -> None:
        ...
        self.assertNotIn("homeassistant_local", order)
...
class PairingStateMachineTests(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.patches = [
            # Unit tests must not probe host interfaces or count the ip helper as an agent spawn.
            patch.object(app, "collect_local_ipv4_context", return_value={}),
    ...
    def test_secret_redaction_filter_in_logs(self) -> None:
        ...
        self.assertIn("unstructured_log_suppressed", output)
